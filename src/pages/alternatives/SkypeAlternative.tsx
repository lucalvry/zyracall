...
import SEOHead, { generateAlternativeSchema, generateBreadcrumbSchema } from "@/components/seo/SEOHead";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
const breadcrumbs = [
  ...
  { name: "Skype Alternative", url: "https://zyracall.com/alternatives/skype-alternative" },
];
...
const SkypeAlternative = () => {
  return (
    <>
      <SEOHead
        title="Best Skype Alternative for International Calls | ZyraCall"
        description="Looking for a Skype alternative? ZyraCall offers browser-based international calling with no app downloads, no subscriptions, and competitive rates to 200+ countries."
        canonicalUrl="https://zyracall.com/alternatives/skype-alternative"
        keywords="Skype alternative, international calling, browser calling, no app, pay as you go, VoIP alternative"
        breadcrumbs={breadcrumbs}
        ogImageTitle="Best Skype Alternative"
        ogImageSubtitle="Browser-based calling, no downloads needed"
        ogImageType="alternative"
        structuredData={generateAlternativeSchema(
          "Skype",
          "https://zyracall.com/alternatives/skype-alternative",
          "Browser-based international calling service as a Skype alternative"
        )}
      />
              ...
              <div className="max-w-4xl mx-auto">
                <Breadcrumb className="mb-8">
                  <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbPage>Skype Alternative</BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>
